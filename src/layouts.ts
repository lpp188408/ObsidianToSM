...
function baseStyles(theme: WechatTheme): LayoutStyles {
  return {
    ...
    blockquote: `font-size:15px;line-height:1.65;border-left:4px solid ${theme.accent};background:${theme.quoteBackground};margin:.5em 0;padding:.3em .65em;color:${theme.body};`,
...
export const LAYOUTS: readonly WechatLayout[] = [
  { id: "none", name: "不套用模板", styles: baseStyles },
  {
    ...
    styles: (theme) => ({
      ...
      blockquote: `font-size:15px;line-height:1.65;margin:.55em 0;padding:.35em .7em;border:0;background:${theme.quoteBackground};color:${theme.body};font-family:Georgia,'Songti SC',serif;`,
  ...
  },
  {
    ...
    styles: (theme) => ({
      ...
      blockquote: `font-size:15px;line-height:1.65;margin:.5em 0;padding:.35em .7em;border:1px solid ${withOpacity(theme.accent, 0.28)};background:${theme.quoteBackground};color:${theme.body};`,
  ...
  },
  {
    ...
    styles: (theme) => ({
      ...
      blockquote: `font-size:15px;line-height:1.65;margin:.5em 0;padding:.3em .65em;border:0;border-left:4px solid ${theme.accent};background:${theme.quoteBackground};color:${theme.body};`,
  ...
  },
  {
    ...
    styles: (theme) => ({
      ...
      h1: `font-size:24px;line-height:1.4;text-align:left;margin:1.15em 0 .6em;font-weight:700;color:${theme.heading};`,
      h2: `font-size:20px;line-height:1.5;text-align:left;margin:1.15em 0 .55em;font-weight:700;color:${theme.heading};`,
      h3: `font-size:18px;line-height:1.5;text-align:left;margin:1em 0 .45em;font-weight:700;color:${theme.heading};`,
      p: `margin:0 0 1em;color:${theme.body};`,
      blockquote: "font-size:15px;line-height:1.65;margin:0 0 .8em;padding:.35em .7em;border:0;border-left:3px solid #9ca3af;background:#f3f4f6;color:#4b5563;",
