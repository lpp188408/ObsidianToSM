...
function baseStyles(theme: WechatTheme): LayoutStyles {
  return {
    ...
    ol: "margin:.55em 0;padding-left:1.35em;",
    ...
    table: "width:100%;margin:.65em 0;border-collapse:collapse;table-layout:auto;font-size:14px;line-height:1.4;",
    th: `padding:.25em .4em;border:1px solid ${theme.accent};background:${theme.quoteBackground};color:${theme.heading};text-align:left;font-weight:700;`,
    td: `padding:.25em .4em;border:1px solid ${theme.accent};color:${theme.body};vertical-align:top;`
  };
}
...
export const LAYOUTS: readonly WechatLayout[] = [
  ...
  },
  {
    ...
    styles: (theme) => ({
      ...
      ol: "margin:0 0 .55em;padding-left:1.5em;",
      li: `margin:.12em 0;color:${theme.body};`,
      hr: "margin:1.5em 0;border:0;border-top:1px solid rgb(15 23 42 / 14%);",
      table: "width:100%;margin:0 0 .65em;border-collapse:collapse;table-layout:auto;font-size:14px;line-height:1.4;",
      th: `padding:.25em .4em;border:1px solid rgb(15 23 42 / 14%);background:rgb(255 255 255 / 48%);color:${theme.heading};text-align:left;font-weight:650;vertical-align:top;word-break:break-word;`,
      td: `padding:.25em .4em;border:1px solid rgb(15 23 42 / 14%);color:${theme.body};text-align:left;vertical-align:top;word-break:break-word;`
    })
  }
];
